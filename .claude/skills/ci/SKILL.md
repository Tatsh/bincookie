...
For example, if a commit contains `bincookie/src/main.cpp`, and `CHANGELOG.md`, the component is
...
- Header file `include/bincookie/util.h` → `util:`.
