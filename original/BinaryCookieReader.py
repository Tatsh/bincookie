...
for np in range(num_pages):
    ...
    page_sizes.append(page_size)  #Each page size: 4 bytes*number of pages

pages=[]
for ps in page_sizes:
    #print(ps, binary_file.tell())
    read = binary_file.read(ps)
    pages.append(read)                      #Grab individual pages and each page will contain >= one cookie
#print(page_sizes)
